...
import 'profil_loeschen_model.dart';
export 'profil_loeschen_model.dart';

class ProfilLoeschenWidget extends StatefulWidget {
  const ProfilLoeschenWidget({super.key});

  @override
  State<ProfilLoeschenWidget> createState() => _ProfilLoeschenWidgetState();
}

class _ProfilLoeschenWidgetState extends State<ProfilLoeschenWidget> {
  late ProfilLoeschenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilLoeschenModel());
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'y8ihk9ye' /* Sobald diese Anwendung im prod... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
